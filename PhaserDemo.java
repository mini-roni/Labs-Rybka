...
class MyLabs extends JFrame {
    ...
    public void resultsLab2(){
        if (boollab2 == true) {
            JOptionPane.showMessageDialog(null, "Result fo IP:\nEntered text is an IP address");
        } else {
        ...
        while(true) {
            ...
            try {
                if (xstr == null || xstr.isEmpty()) {
                    throw new RuntimeException("UNEXPECTED VALUES: The program cannot take in a null value\n");
                }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "UNEXPECTED VALUES: The program cannot take in a String\n");
                continue;
            }

            try {
                if (x < 0) {
                    throw new RuntimeException("UNEXPECTED VALUES: The program cannot take values that are lower than zero\n");
                } else {
                    break;
                }
